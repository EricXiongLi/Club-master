...
export default new Router({
...

    {
      path: '/registerUser',
      name: 'registerUser',
      component: resolve => require(['@/components/user/registerUser'],resolve),
    },
...

    {
      path: '/',
      name: 'Ordinary',
      component: resolve => require(['@/Ordinary.vue'],resolve),
      children: [
        {
          path: '/ordinaryMyActivity',
          name: 'ordinaryMyActivity',
          component: resolve => require(['@/components/ordinaryUser/ordinaryMyActivity'],resolve),
        },

        {
          path: '/ordinaryMyInformation',
          name: 'ordinaryMyInformation',
          component: resolve => require(['@/components/ordinaryUser/ordinaryMyInformation'],resolve),
        },
        {
          path: '/ordinaryUserLeft',
          name: 'ordinaryUserLeft',
          component: resolve => require(['@/components/ordinaryUser/ordinaryUserLeft'],resolve),
        },

        {
          path: '/ordinaryHome',
          name: 'ordinaryHome',
          component: resolve => require(['@/components/ordinaryUser/ordinaryHome'],resolve),
        },

        {
          path: '/ordinaryActivity',
          name: 'ordinaryActivity',
          component: resolve => require(['@/components/ordinaryUser/ordinaryActivity'],resolve),
        },

        {
          path: '/ordinaryJoinActivity',
          name: 'ordinaryJoinActivity',
          component: resolve => require(['@/components/ordinaryUser/ordinaryJoinActivity'],resolve),
        },

        {
          path: '/ordinaryUserList',
          name: 'ordinaryUserList',
          component: resolve => require(['@/components/ordinaryUser/ordinaryUserList'],resolve),
        }
