<template>
  <div class="login-container">
    <el-form :model="user" status-icon ref="user" label-width="100px" class="loginForm">
      <h1 class="login-title">Welcome to SED</h1>
      <br/>
      <br/>
      ...
      <router-link :to="{ name: 'registerUser' }">还没有账号？现在注册</router-link>
      <el-form-item>
...
//仅有当用户名字为admin@163.com时才进入到home
              if (this.user.account == "admin@163.com") {
